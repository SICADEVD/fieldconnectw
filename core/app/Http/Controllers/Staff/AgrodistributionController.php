...
class AgrodistributionController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('staff.distribution.index', compact('pageTitle', 'distributions','localites'));
    }
    ...
    public function create()
    {
        ...
        return view('staff.distribution.create', compact('pageTitle', 'producteurs','localites'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('staff.distribution.edit', compact('pageTitle','distribution','somme','total','results'));
    } 
