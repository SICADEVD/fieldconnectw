...
class SsrteclmrsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('staff.ssrteclmrs.index', compact('pageTitle', 'ssrteclmrs','localites'));
    }
    ...
    public function create()
    {
        ...
        return view('staff.ssrteclmrs.create', compact('pageTitle', 'producteurs','localites','raisonArretEcole','travauxDangereux','lieuTravaux','travauxLegers','lienParente','niveauEtude','moyenTransport','classes'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('staff.ssrteclmrs.edit', compact('pageTitle', 'localites', 'ssrteclmrs','producteurs','raisonArretEcole','travauxDangereux','lieuTravaux','travauxLegers','lienParente','niveauEtude','moyenTransport','classes'));
    } 
