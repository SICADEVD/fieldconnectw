...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-lg-12 mb-30">
            <div class="card">
                <div class="card-body"> 
         {!! Form::model($producteur, ['method' => 'POST','route' => ['manager.traca.producteur.store', $producteur->id],'class'=>'form-horizontal', 'id'=>'flocal', 'enctype'=>'multipart/form-data']) !!}
                            ...
                            <div class="form-group row">
                                ...
                                <select class="form-control" name="localite">
                                    ...
                                    @foreach ($localites as $localite)
                                        <option value="{{ $localite->id }}"  @selected($localite->id==$producteur->localite_id) >{{ __($localite->nom) }}
                                        </option>
                                    @endforeach
                                </select>
                                </div> 
...
<div class="col-xs-12 col-sm-8">
     <input type="file" name="copiecarterecto" value="" accept="image/*" class="form-control dropify-fr" placeholder="Choisir une fichier" id="copiecarterecto" data-default-file="{{ asset('core/storage/app/' . $producteur->copiecarterecto) }}">
...
<div class="col-xs-12 col-sm-8">
     <input type="file" name="copiecarteverso" value="" accept="image/*" class="form-control dropify-fr" placeholder="Choisir une fichier" id="copiecarteverso" data-default-file="{{ asset('core/storage/app/' . $producteur->copiecarteverso) }}">
...
<div class="col-xs-12 col-sm-8">
      <input type="file" name="picture" accept="image/*" class="form-control dropify-fr" placeholder="Choisir une image" id="image" data-default-file="{{ asset('core/storage/app/' . $producteur->picture) }}">
</div>
</div> 
<hr class="panel-wide">
