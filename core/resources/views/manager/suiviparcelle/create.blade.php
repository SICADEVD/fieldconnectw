...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-lg-12 mb-30">
            <div class="card">
                <div class="card-body"> 
                    {!! Form::open(array('route' => ['manager.suivi.parcelles.store'],'method'=>'POST','class'=>'form-horizontal', 'id'=>'flocal', 'enctype'=>'multipart/form-data')) !!} 
    ...
    <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::select('varietes_cacao', ["Tout Venant"=>"Tout Venant","Mercedes"=>"Mercedes","Autre"=>"Autre"], null, array('placeholder' => __("Selectionner une option"),'class' => 'form-control varietes_cacao', 'id'=>'varietes_cacao')); ?>
        </div>
    </div>
        ...
        <div class="form-group row" id="autreVariete">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::text('autreVariete', null,array('placeholder' => __("Préciser l'autre variété"),'class' => 'form-control autreVariete')); ?>
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::select('existeCoursEaux', ['oui' => __('oui'), 'non' => __('non')], null,array('placeholder' =>__("Selectionner une option"),'class' => 'form-control existeCoursEaux')); ?>
        </div>
    </div>
        ...
        <div class="form-group row" id="courseaux">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::select('cours_eaux', ["Bas-fond"=>"Bas-fond","Marigot"=>"Marigot","Rivière"=>"Rivière","Source d'eau Naturelle"=>"Source d'eau Naturelle"], null, array('placeholder' =>__("Selectionner une option"),'class' => 'form-control cours_eaux', 'id'=>'cours_eaux_id')); ?>
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::select('pente', ['oui' => __('oui'), 'non' => __('non')], null,array('placeholder' =>__("Selectionner une option"),'class' => 'form-control pente')); ?>
        </div>
    </div>
 ...
 <tr>
            <td class="row">
            <div class="col-xs-12 col-sm-12 bg-success"><badge  class="btn  btn-outline--warning h-45 btn-sm">@lang("Information Arbre à Ombrage")</badge></div>
            <div class="col-xs-12 col-sm-6">
        <div class="form-group row">
            {{ Form::label(__('Variete'), null, ['class' => '']) }}
            <input type="text" name="varietesOmbrage[]" placeholder="..." id="varietesOmbrage-1" class="form-control">
        </div>
        </div>
...
<tr>
    ...
    <hr class="panel-wide">
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::text('varieteAbres', null,array('placeholder' => __("Entrer le nom de la variété d'arbre"),'class' => 'form-control varieteAbres')); ?>
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::number('nombreSauvageons',null,array('placeholder' => __('Nombre'),'class' => 'form-control nombreSauvageons','min'=>'0')); ?>
        </div>
    </div>
    ...
    <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::select('arbresagroforestiers', ['non' => __('non'),'oui' => __('oui')], null,array('class' => 'form-control arbresagroforestiers')); ?>
        </div>
    </div>
 ...
 <tr>
        ...
        <div class="form-group row">
            ...
            <input type="text" name="agroforestiers[]" placeholder="..." id="agroforestiers-1" class="form-control">
        </div>
        </div>
        ...
        <div class="form-group row">
            {{ Form::label(__('Nombre'), null, ['class' => '']) }}
            <input type="number" name="nombreagroforestiers[]" placeholder="..." id="nombreagroforestiers-1" class="form-control " min="1">
        </div>
        </div>
...
<tr>
    ...
    <hr class="panel-wide">
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::select('activiteTaille', ['Faible' => __('faible'), 'Moyen' => __('moyen'), 'Eleve' => __('eleve')], null,array('class' => 'form-control activiteTaille')); ?>
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::select('activiteEgourmandage', ['Faible' => __('faible'), 'Moyen' => __('moyen'), 'Eleve' => __('eleve')], null,array('class' => 'form-control activiteEgourmandage')); ?>
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::select('activiteDesherbageManuel', ['Faible' => __('faible'), 'Moyen' => __('moyen'), 'Eleve' => __('eleve')], null,array('class' => 'form-control activiteDesherbageManuel')); ?>
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::select('activiteRecolteSanitaire', ['Faible' => __('faible'), 'Moyen' => __('moyen'), 'Eleve' => __('eleve')], null,array('class' => 'form-control activiteRecolteSanitaire')); ?>
        </div>
    </div>
    ...
    <hr class="panel-wide">
             ...
             <div class="form-group row">
                 ...
                 <?php echo Form::number('nombresacsNPK', 0,array('placeholder' => 'Nombre de sacs utilisé...','class' => 'form-control','min'=>'0') ); ?>
             </div>
         </div>
             ...
             <?php echo Form::hidden('intrantFiente', 'Fiente',array('class' => 'form-control intrant')); ?>
                 <?php echo Form::number('nombresacsFiente', 0,array('placeholder' => 'Nombre de sacs utilisé...','class' => 'form-control','min'=>'0') ); ?>
             </div>
         </div>
         <div class="form-group row">
             ...
             <?php echo Form::hidden('intrantComposte', 'Composte',array('class' => 'form-control intrant')); ?>
                 <?php echo Form::number('nombresacsComposte', 0,array('placeholder' => 'Nombre de sacs utilisé...','class' => 'form-control','min'=>'0') ); ?>
             </div>
         </div>
         ...
         <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::select('presencePourritureBrune', ['Assez' => __('assez'), 'Moins' => __('moins')], null,array('class' => 'form-control presencePourritureBrune')); ?>
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::select('presenceBioAgresseur', ['Assez' =>__('assez'), 'Moins' => __('moins')], null,array('class' => 'form-control presenceBioAgresseur')); ?>
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::select('presenceInsectesRavageurs', ['Assez' =>__('assez'), 'Moins' => __('moins')], null,array('class' => 'form-control presenceInsectesRavageurs')); ?>
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::select('presenceFourmisRouge', ['Assez' => __('assez'), 'Moins' => __('moins')], null,array('class' => 'form-control presenceFourmisRouge')); ?>
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::select('presenceAraignee', ['Assez' => __('assez'), 'Moins' => __('moins')], null,array('class' => 'form-control presenceAraignee')); ?>
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::select('presenceVerTerre', ['Assez' => __('assez'), 'Moins' => __('moins')], null,array('class' => 'form-control presenceVerTerre')); ?>
        </div>
    </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
                 <?php echo Form::select('presenceMenteReligieuse', ['Assez' => __('assez'), 'Moins' => __('moins')], null,array('class' => 'form-control presenceMenteReligieuse')); ?>
        </div>
    </div>
    ...
    <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::select('presenceSwollenShoot', ['oui' => __('oui'), 'non' => __('non')], null,array('class' => 'form-control presenceSwollenShoot')); ?>
        </div>
    </div>
    <hr class="panel-wide">
    <div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
                 <?php echo Form::select('presenceInsectesParasites', ['non' => __('non'), 'oui' => __('oui')], null,array('class' => 'form-control presenceInsectesParasites')); ?>
        </div>
    </div>
 ...
 <tr>
        ...
        <div class="form-group row">
            ...
            <input type="text" name="insectesParasites[]" placeholder="Nom" id="insectesParasites-1" class="form-control">
        </div>
        </div>
...
<tr>
 ...
 <tr>
        ...
        <div class="form-group row">
            {{ Form::label(__('Nom'), null, ['class' => '']) }}
            <?php echo Form::text('nomFongicide', null,array('class' => 'form-control') ); ?>
        </div>
        </div>
        ...
        <div class="form-group row">
            {{ Form::label(__("Nombre de Boite"), null, ['class' => '']) }}
            <?php echo Form::number('nombreFongicide', null,array('class' => 'form-control','min'=>'1') ); ?>
        ...
        <div class="form-group row">
            {{ Form::label(__('Nom'), null, ['class' => '']) }}
            <?php echo Form::text('nomHerbicide', null,array('class' => 'form-control') ); ?>
        </div>
        </div>
        ...
        <div class="form-group row">
            {{ Form::label(__("Nombre de Boite"), null, ['class' => '']) }}
            <?php echo Form::number('nombreHerbicide', null,array('class' => 'form-control','min'=>'1') ); ?>
...
<div class="form-group row">
            ...
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::number('nombreDesherbage', null,array('class' => 'form-control','min'=>'1') ); ?>
        </div>
    </div>
        <div class="form-group row">
            {{ Form::label(__("Date de la visite"), null, ['class' => 'col-sm-4 control-label required']) }}
            <div class="col-xs-12 col-sm-8">
            <?php echo Form::date('dateVisite', null,array('class' => 'form-control dateactivite required','required'=>'required') ); ?>
        </div>
    </div>
...
var html_table = '<tr>';
html_table +='<td class="row"><div class="col-xs-12 col-sm-12 bg-success"><badge class="btn  btn-outline--warning h-45 btn-sm">Information Arbre à Ombrage ' + productCount + '</badge></div><div class="col-xs-12 col-sm-6"><div class="form-group"><label for="varietesOmbrage" class="">Variété</label><input placeholder="Variété arbre..." class="form-control" id="varietesOmbrage-' + productCount + '" name="varietesOmbrage[]" type="text"></div></div><div class="col-xs-12 col-sm-6"><div class="form-group"><label for="nombreOmbrage" class="">Nombre</label><input type="number" name="nombreOmbrage[]" placeholder="Nombre d\'arbre" min="1" id="nombreOmbrage-' + productCount + '" class="form-control " value=""></div></div><div class="col-xs-12 col-sm-8"><button type="button" id="' + productCount + '" class="removeRow btn btn-danger btn-sm"><i class="fa fa-minus"></i></button></div></td>';
...
//---> Start create table tr
var html_table = '<tr>';
html_table +='<td class="row"><div class="col-xs-12 col-sm-12 bg-success"><badge class="btn  btn-outline--warning h-45 btn-sm">Arbre agro-forestier ' + agroforestiersCount + '</badge></div><div class="col-xs-12 col-sm-6"><div class="form-group"><label for="agroforestiers" class="">Type</label><input placeholder="Type arbre..." class="form-control" id="agroforestiers-' + agroforestiersCount + '" name="agroforestiers[]" type="text"></div></div><div class="col-xs-12 col-sm-6"><div class="form-group"><label for="nombreagroforestiers" class="">Nombre</label><input type="number" name="nombreagroforestiers[]" placeholder="Nombre d\'arbre" id="nombreagroforestiers-' + agroforestiersCount + '" class="form-control " min="1" value=""></div></div><div class="col-xs-12 col-sm-8"><button type="button" id="' + agroforestiersCount + '" class="removeRowagroforestiers btn btn-danger btn-sm"><i class="fa fa-minus"></i></button></div></td>';
...
//---> Start create table tr
var html_table = '<tr>';
html_table +='<td class="row"><div class="col-xs-12 col-sm-12 bg-success"><badge class="btn  btn-outline--warning h-45 btn-sm">Animal ' + animauxRencontresCount + '</badge></div><div class="col-xs-12 col-sm-12"><div class="form-group"><label for="animauxRencontres" class="">Animal</label><input placeholder="Nom animal..." class="form-control" id="animauxRencontres-' + animauxRencontresCount + '" name="animauxRencontres[]" type="text"></div></div><div class="col-xs-12 col-sm-12"><button type="button" id="' + animauxRencontresCount + '" class="removeRowanimauxRencontres btn btn-danger btn-sm"><i class="fa fa-minus"></i></button></div></td>';
