...
@section('panel')
    <div class="row mb-none-30">
        <div class="col-lg-12 mb-30">
            <div class="card">
                <div class="card-body"> 
         {!! Form::model($estimation, ['method' => 'POST','route' => ['staff.traca.estimation.store', $estimation->id],'class'=>'form-horizontal', 'id'=>'flocal', 'enctype'=>'multipart/form-data']) !!}
...
@push('breadcrumb-plugins')
    <x-back route="{{ route('staff.traca.estimation.index') }}" />
@endpush
