...
<div class="row mb-none-30">
    <div class="col-lg-12 col-md-12 mb-30">
        <div class="card">
            <form action="{{route('staff.livraison.update',encrypt($livraisonInfo->id))}}" method="POST">
                <div class="card-body">
                    @csrf
                    <div class="row">
...
@push('breadcrumb-plugins') 
    <x-back route="{{ route('staff.livraison.sent.queue') }}" />
@endpush
@push('script-lib')
...
<script>
    ...
    function getParcelle(id){
        ...
        $.ajax({
                type:'get',
                url: "{{ route('staff.livraison.get.parcelle') }}",
                data: {
                    'id': prod
                },
