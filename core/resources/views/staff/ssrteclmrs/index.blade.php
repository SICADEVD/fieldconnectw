                            ...
                            <tbody>
                                @forelse($ssrteclmrs as $data)
                                    <tr>
                                        ...
                                        <td>
                                            <span> <a href="{{ route('staff.suivi.ssrteclmrs.edit', $data->id) }}">
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu p-0">
                                                <a href="{{ route('staff.suivi.ssrteclmrs.edit', $data->id) }}"
                                                    class="dropdown-item"><i class="la la-pen"></i>@lang('Edit')</a> 
                                                @if ($data->status == Status::DISABLE)
                                                    <button type="button" class="confirmationBtn  dropdown-item"
                                                        data-action="{{ route('staff.suivi.ssrteclmrs.status', $data->id) }}"
...
@push('breadcrumb-plugins')
    ...
    <a href="{{ route('staff.suivi.ssrteclmrs.create') }}" class="btn  btn-outline--primary h-45 addNewCooperative">
        <i class="las la-plus"></i>@lang("Ajouter nouveau")
    </a>
    <a href="{{ route('staff.suivi.ssrteclmrs.exportExcel.ssrteclmrsAll') }}" class="btn  btn-outline--warning h-45"><i class="las la-cloud-download-alt"></i> Exporter en Excel</a>
@endpush
@push('style')
    <style>
        .table-responsive {
